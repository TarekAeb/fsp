...
const Directors = () => {
  ...
  const handleDelete = async (id: number) => {
    try {
      ...
      if (response.ok) {
        ...
        toast.success("The director has been successfully deleted.");
      } else {
  ...
  const handleFile = (file: File) => {
    ...
    if (!file.type.match(/image\/(jpeg|jpg|png|gif|webp)/)) {
      toast.info("File must be an image (JPEG, PNG, GIF, WEBP)");
      return;
    }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error ||
            `Failed to ${editingId ? "update" : "create"} director`
        );
      }

      toast.success(
        `The director has been successfully ${
      ...
      console.error(
        `Error ${editingId ? "updating" : "creating"} director:`,
        error
      );
      toast.error(
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            This will permanently delete {director.name} from
                            the directors list. This action cannot be undone.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
